...
def keluar ():
	os.system ('clear')
	cetak "\ 033 [1; 91m [!] Menutup alat ..."
	os.system ('tidur 3 && bersih')
	os.system ('xdg-bukah ttps://youtu.be/1TIQdVmnOBM ')
	os.sys.exit ()
        tool_main_function ()
...
│ █ ▀▄▄▀█ ▀█▄▄▀ ▀█▄▄▀ ██▄█▀ ▀█▄█▀ ▀█▄█▀ █ ▀▄ │ \ 033 [1; 91m        
│                                        __ _ _
│                       _ __ __ _ / _| (_) │ \ 033 [1; 91m
│                      | '__/ _` | |_| | |    │ \ 033 [1; 91m
│                      | | | (_| |  _| | |       │ \ 033 [1; 91m      
│                      |_|  \__,_|_| |_|_|  │ \ 033 [1; 91m
└──────────────────────────────────────────────── ────────────┘ \ 033 [1; 91m
\ 033 [1; 97m╔═══════════════════════════════════════════ ══════════════════╗
\ 033 [1; 97m║ \ 033 [1; 93m * \ 033 [1; 97mTeam \ 033 [1; 91m: \ 033 [1; 96mAnonySulsel-palopo \ 033 [1; 97m ║ "
\ 033 [1; 97m║ \ 033 [1; 93m * \ 033 [1; 97mFb \ 033 [1; 91m: \ 033 [1; 96mRafli id \ 033 [1; 97m ║ "
\ 033 [1; 97m║ \ 033 [1; 93m * \ 033 [1; 97mYouTube \ 033 [1; 91m: \ 033 [1; 92m \ 033 rafly pake i\ 033 [0m \ 033 [1; 97m ║
\ 033 [1; 97m║ \ 033 [1; 93m * \ 033 [1; 97mWa \ 033 [1; 91m: \ 033 [1; 96m 082290232340\ 033 [1; 97m ║
\ 033 [1; 97m║ \ 033 [1; 93m * \ 033 [1; 97mNotice \ 033 [1; 91m: \ 033 [1; 96mJadilah jahat jika baikmu di sepelekan \ 033 [1; 97m ║
\ 033 [1; 97m║ \ 033 [1; 93m * \ 033 [1; 97mRafly \ 033 [1; 91m: \ 033 [1; 92m \ 033 [4mrafli=>orang jahat adalah orang baik yang tersakiti\ 033 [0m \ 033 [1; 97m ║ "
\ 033 [1; 97m╚═══════════════════════════════════════════ ══════════════════╝ "" "
...
def tool_main_function ():
	os.system ('clear')
	cetak logo
	cetak "\ 033 [1; 97m║ - \ 033 [1; 91m> \ 033 [1; 92m1. \ 033 [1; 97m Login normal"
	cetak "\ 033 [1; 97m║ - \ 033 [1; 91m> \ 033 [1; 92m2. \ 033 [1; 97m Token login"
	cetak "\ 033 [1; 97m║ - \ 033 [1; 91m> \ 033 [1; 91m0. \ 033 [1; 97m Exit"
	cetak "\ 033 [1; 97m║"
	login_method = raw_input ("\ 033 [1; 97m╚═ \ 033 [1; 91m >>> \ 033 [1; 97m")
	jika login_method == "":
		cetak "\ 033 [1; 91m [!] Masukan salah"
		keluar()
	elif login_method == "1":
		Gabung()
	elif login_method == "2":
...
def login ():
	os.system ('clear')
	mencoba:
		fb_token = buka ('login.txt', 'r')
		Tidak bisa()
	kecuali (KeyError, IOError):
		os.system ('clear')
		cetak logo
		cetak ('\ 033 [1; 91m [☆] \ 033 [1; 92mFACEBOOK LOGIN \ 033 [1; 91m [☆]')
		id = input_makan ('\ 033 [1; 91m [+] \ 033 [1; 36mID \ 033 [1; 97m | \ 033 [1; 96mEmail \ 033 [1; 97m \ 033 [1; 91m: \ 033 [1] ; 92m ')
		pwd = getpass.getpass ('\ 033 [1; 91m [+] \ 033 [1; 36mPassword \ 033 [1; 91m: \ 033 [1; 92m')
		beban()
		mencoba:
			br.open ('https://m.facebook.com')
		kecuali mekanisasi.URLError:
			cetak "\ n \ 033 [1; 91m [!] Tidak ada koneksi"
			keluar()
